...
async function GetSlipList() {
  ...
  let res = await fetch(`${apiUrl}/Sliplist`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function GetBanking() {
  ...
  let res = await fetch(`${apiUrl}/bankings`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function GetStudentLists() {
  ...
  let res = await fetch(`${apiUrl}/StudentList`,requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function Sliplist(data: SliplistInterface) {
  const requestOptions = {
    method: "POST",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
...
async function GetScholarship() {
  ...
  let res = await fetch(`${apiUrl}/scholarship`, requestOptions)
  .then((response) => response.json())
  .then((res) => {
    if (res.data) {
      return res.data;
...
async function GetTypes() {
  ...
  let res = await fetch(`${apiUrl}/scholarshipstype`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function Scholarship(data: ScholarshipInterface) {
  const requestOptions = {
    method: "POST",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
